...
<div class="container">
    ...
    <div class="row">
        <form name="hr" action="index1.php" method="post">
            <div class="form-group">
                ...
                <input type="text" name="gross" class="form-control" value=<?php echo $_POST['gross']?>>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="quantity_family" class="form-control" value=<?php echo $_POST['quantity_family']?>>
            </div>
    ...
    <div class="row">
        <p id="net" style="color: #f7941d; margin: 30px; font-size: 24px">1. Lương gross : <?php echo $_POST['gross'] ?></p>
        <p id="net" style="color: #f7941d; margin: 30px; font-size: 24px">2. Phần trăm bảo hiểm y tế : <?php echo $_POST['medical'] ?></p>
        <p id="net" style="color: #f7941d; margin: 30px; font-size: 24px">3. Bảo hiểm y tế : <?php echo $bao_hiem_y_te ?></p>
        <p id="net" style="color: #f7941d; margin: 30px; font-size: 24px">4. Phần trăm bảo hiểm xã hội : <?php echo $_POST['social'] ?></p>
        <p id="net" style="color: #f7941d; margin: 30px; font-size: 24px">5. Bảo hiểm xã hội : <?php echo $bao_hiem_xa_hoi ?></p>
        <p id="net" style="color: #f7941d; margin: 30px; font-size: 24px">6. Phần trăm bảo hiểm thất nghiệp : <?php echo $_POST['work'] ?></p>
        ...
        <p id="net" style="color: #f7941d; margin: 30px; font-size: 24px">10. Giảm trừ cá nhân : <?php echo $_POST['personal'] ?></p>
        <p id="net" style="color: #f7941d; margin: 30px; font-size: 24px">11. Số người phụ thuộc : <?php echo $_POST['quantity_family'] ?></p>
        <p id="net" style="color: #f7941d; margin: 30px; font-size: 24px">12. Giàm trừ theo 1 người phụ thuộc : <?php echo $_POST['family'] ?></p>
        <p id="net" style="color: #f7941d; margin: 30px; font-size: 24px">13. Tổng giảm trừ người phụ thuộc : <?php echo ($_POST['quantity_family']*$_POST['family']) ?></p>
