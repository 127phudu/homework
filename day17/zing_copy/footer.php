<footer>
    <div class="wrapper">
        ...
        <div class="copyright">
            <div class="logo">
                <a href="https://news.zing.vn">
                    <img src="//znews-stc.zdn.vn/static/logo/logo_zing_trithuc.png" width="130">
                </a>
                <p>
                    <a href="https://adtima.vn/lien-he?utm_source=zingnews&utm_medium=footer" target="_blank">Quảng cáo</a>
                </p>
            </div>
            <p class="info vcard">
...
<div id="toolbox">
    <ul>
        ...
        <li class="email"><a href="mailto:toasoan@news.zing.vn" title="Gửi email"><span>toasoan@news.zing.vn</span></a></li>
        <li class="phone"><a href="javascript:alert('Thông tin phản hồi cho tòa soạn qua đường dây nóng 0985.57.88.55');" title="Điện thoại nóng"><span>0985.57.88.55</span></a></li>
    </ul>
</div>
<!-- LIVE FOOTER CONFIG -->
<div id="advBalloon"></div>
<!--<script src="//znews-static.zadn.vn/campaign/pregnancy/desktop/js/widget_003.js" type="text/javascript"></script>-->
<script src="//znews-static.zadn.vn/js/znews_5.21.250.js" type="text/javascript"></script>
<script>
...
<!-- ADTIMA -->
<script>
    if (!window.disableAdtimaBanner && window.innerWidth > 1000) {
        (function(d, s, id){
            var js, fjs = d.getElementsByTagName(s)[0];
            if (d.getElementById(id)){ return; }
            js = d.createElement(s); js.id = id;
...
// remote script has loaded
            ...
            js.src = "//adtima-static.zadn.vn/resource/js/znews/web.180920.1.js";
            fjs.parentNode.insertBefore(js, fjs);
...
<!-- Cookie = , Key = default, time: 2018/09/22 20:48:24 -->