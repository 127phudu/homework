    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
                ...
                if (isset($_POST['quantity']) && isset($_POST['product_id'])) {
                    ...
                    if (isset($_SESSION['cart_item']) && !empty($_SESSION['cart_item'])) {
                        ...
                        if (isset($_SESSION['cart_item'][$product_id])) {
                            //sản phẩm thêm đã tồn tại trong giỏ
                            ...
                            //sản phẩm thêm chưa tồn tại trong giỏ
                            $cart_item = array();
                            $cart_item['id'] = $product['id'];
                            $cart_item['product_name'] = $product['product_name'];
                            $cart_item['product_image'] = $product['product_image'];
            ...
            case 'remove':
                ...
                break;
            default:
                echo 'action ko ton tai';
                die;
        }
    }
}

header("Location: http://localhost/homework/simple_shop/index.php");
die();